...
import com.example.diego.proyectoseguridad.Vista.AjustesFragment;

/**
 * Created by diego on 3/7/2016.
 */
public class EscogerColor extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.dialogo_temas, container);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.card_view1:
                ...
                ((AjustesFragment) getActivity()).setThemeFragment(1);
                break;
            case R.id.card_view2:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(2);
                break;
            case R.id.card_view3:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(3);
                break;
            case R.id.card_view4:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(4);
                break;
            case R.id.card_view5:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(5);
                break;
            case R.id.card_view6:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(6);
                break;
            case R.id.card_view7:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(7);
                break;
            case R.id.card_view8:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(8);
                break;
            case R.id.card_view9:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(9);
                break;
            case R.id.card_view10:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(10);
                break;
            case R.id.buttonDisagree:
                sharedPreferences.edit().putBoolean("THEMECHANGED", false).apply();
                ((AjustesFragment) getActivity()).setThemeFragment(currentTheme);
                getDialog().dismiss();
                break;
            case R.id.buttonAgree:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                intent = new Intent(getActivity(), AjustesFragment.class);
